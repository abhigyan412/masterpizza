...
import { searchInitValue as masterParams } from "../../../utils/Master/ModifierUtils";
import Select from "react-select";

const ModifierDetails = ({ setViewState, selectedRecord, setAlert }) => {
  ...
  useEffect(() => {
    ...
    if (selectedRecord?.itemid) {
      ...
      api
        .post(ITEM_PACKAGE.GET_ITEM_SIZE, data)
        .then((response) => {
