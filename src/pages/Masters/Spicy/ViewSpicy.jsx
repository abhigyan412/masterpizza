...
import { searchFieldSet } from "../../../utils/Master/SpicyUtils";
...
const ViewSpicy = ({
  ...
  const searchParams = (values) => {
    ...
    result = result.filter((stu) => {
      return stu.Spicyname.toLowerCase().includes(values.toLowerCase());
    });
    setReclist(result);
  };
  ...
  return (
    <div className="content-shrink">
      <LayoutControls title="Spicy List" options={manageOptions} />
      <hr />
      {isViewSearch && (
        <SearchForm
