...
import { searchFieldSet } from "../../../utils/Master/ItemTypeUtils";
...
const ViewItemType = ({
  ...
  const changeViewSearch = () => setViewSearch(true);
  ...
  return (
    <div className="content-shrink">
      <LayoutControls title="Item Type List" options={manageOptions} />
      <hr />
      {isViewSearch && (
        <SearchForm
